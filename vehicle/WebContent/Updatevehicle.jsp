...
function update1()
{
	...
	//var data="Enter the updated insurance expiry date";
...
<br><input type="radio"  name="choice" value="1" onClick='update1()' id="choice1"> <label >Insurance Expiry</label>
<br><input type="radio"  name="choice" value="2" onClick='update2()' id="choice2"> <label >Last Serviced Date</label>
<br><input type="radio"  name="choice" value="3" onClick='update3()' id="choice3"> <label >Service Due Date</label>
<br>
